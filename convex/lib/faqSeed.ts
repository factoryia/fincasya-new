...
export const FAQ_INITIAL_SEED: Array<{
  ...
  },
  {
    ...
    text: [
      ...
      '',
      'Si deseas que te contactemos con el personal para tu fecha seleccionada, ¡avísanos para coordinarlo! 👨‍💻✨',
    ].join('\n'),
  },
  {
    ...
    text: [
      ...
      '',
      '⏰ Late Check-out: Si deseas salir más tarde, puedes solicitarlo con nuestro equipo para verificar disponibilidad. Ten en cuenta que este servicio puede tener un costo adicional.',
      '',
