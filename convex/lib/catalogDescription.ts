...
/**
 * Quita líneas numeradas (1. 2. …) y URLs de fincasya en cualquier parte del texto.
 * Devuelve nombres extraídos por si no hay features en BD.
 */
...
/** @deprecated Use stripNumberedListFromDescription */
...
/** Descripción libre + amenidades con emojis para Meta/WhatsApp (sin numeración). */
