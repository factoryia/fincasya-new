...
export class FincasService {
  ...
  async generateContract(
    ...
    try {
      ...
      // 2. CÃ¡lculo del precio total (Precio por dÃ­a * Total de dÃ­as + Cargos por mascotas)
      ...
      // - 3Âª en adelante: 30,000 COP c/u (No Reembolsable)
      ...
      // Sumar al precio final (como solicitÃ³ el usuario)
